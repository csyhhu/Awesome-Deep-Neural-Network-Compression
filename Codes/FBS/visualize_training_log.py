"""
A script to visualize training log for FBS
"""
...
import argparse
parser = argparse.ArgumentParser(description='FBS Visualization')
args = parser.parse_args()

method_list = {

    '../Results/ResNet20-CIFAR10/runs-FBS/Optimizer-Adam-CR-0.500':
        {'name': 'FBS', 'color': 'k'},
}
